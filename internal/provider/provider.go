...
func (p *openWebUIProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewModelDataSource,
		NewModelsDataSource,
		NewBaseModelsDataSource,
		NewModelTagsDataSource,
		NewModelsExportDataSource,
		NewKnowledgeDataSource,
		NewKnowledgeFilesDataSource,
		NewGroupDataSource,
		NewPromptDataSource,
		NewPromptsDataSource,
		NewPromptTagsDataSource,
		NewPromptHistoryDataSource,
		NewPromptHistoryEntryDataSource,
		NewPromptHistoryDiffDataSource,
		NewToolDataSource,
		NewFunctionDataSource,
		NewFunctionsDataSource,
		NewToolsDataSource,
		NewToolsExportDataSource,
		NewPipelineDataSource,
		NewFileDataSource,
		NewFilesDataSource,
		NewFileContentDataSource,
		NewFileProcessStatusDataSource,
		NewConfigExportDataSource,
		NewUserDataSource,
		NewRetrievalConfigDataSource,
		NewEvaluationsConfigDataSource,
		NewDefaultUserPermissionsDataSource,
		NewToolServerVerifyDataSource,
		NewTerminalServerVerifyDataSource,
		NewFolderDataSource,
	}
}
